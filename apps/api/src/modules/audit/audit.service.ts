...
export const AuditActions = {
  ...
  FAILED_LOGIN_INVALID_CREDENTIALS: 'FAILED_LOGIN_INVALID_CREDENTIALS',
  FAILED_LOGIN_ACCOUNT_LOCKED: 'FAILED_LOGIN_ACCOUNT_LOCKED',
  FAILED_LOGIN_ACCOUNT_INACTIVE: 'FAILED_LOGIN_ACCOUNT_INACTIVE',
